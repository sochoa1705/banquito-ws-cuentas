...
public class AccountTransaction {
    ...
    @Column(name = "CREDITOR_BANK_CODE", nullable = false, length = 20)
    private String creditorBankCode;

    @Column(name = "CREDITOR_ACCOUNT", nullable = false, length = 16)
    private String creditorAccount;

    @Column(name = "DEBTOR_BANK_CODE", nullable = false, length = 20)
    private String debtorBankCode;

    @Column(name = "DEBTOR_ACCOUNT", nullable = false, length = 16)
    ...
    @Column(name = "PARENT_TRANSACTION_KEY", nullable = false, length = 36)
