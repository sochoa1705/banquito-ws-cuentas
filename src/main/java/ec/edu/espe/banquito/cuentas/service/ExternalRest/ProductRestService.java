package ec.edu.espe.banquito.cuentas.service.ExternalRest;
...
public class ProductRestService {
    ...
    // public ClientAccountRestRS sendObtainInformationProductRequest(String typeClient, String uniqueKey) {
    //     String url;
    ...
    //     ResponseEntity<Object> response = restTemplate.getForEntity(url, ClientAccountRestRS.class);
